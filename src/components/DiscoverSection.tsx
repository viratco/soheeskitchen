...
const DiscoverSection = () => {
    return (
        <section className="relative w-full bg-white pb-24 pt-32">
            ...
            <div className="mx-auto max-w-7xl px-6">
                <div className="grid grid-cols-1 items-center gap-16 md:grid-cols-2">
                    ...
                    <div className="flex flex-col text-left">
                        ...
                        <h2 className="mb-8 text-6xl font-black uppercase leading-none tracking-tight text-[#2d1b11] font-[family-name:var(--font-oswald)]">
                            We Cook And
                            <br />
                            Share Our
                            <br />
                        ...
                        <div className="mt-8">
                            <h3 className="mb-4 text-3xl font-bold uppercase leading-tight text-[#2d1b11] font-[family-name:var(--font-oswald)]">
                                Passion For Cooking
                            </h3>
