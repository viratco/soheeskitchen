...
const CraftSection = () => {
    return (
        <section className="relative w-full bg-[#1a0f0a] py-16 md:py-24 text-white">
            <div className="mx-auto max-w-7xl px-4 md:px-6">

                {/* Main Content Area */}
                <div className="relative mb-16 md:mb-24 grid grid-cols-1 gap-8 md:gap-12 lg:grid-cols-12">

                    {/* Left & Center: Headline */}
                    <div className="lg:col-span-8">
                        <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold uppercase leading-tight tracking-tight font-[family-name:var(--font-oswald)]">
                ...
                <div className="flex flex-col gap-12">
                    {[
                        ...
                        <div key={index} className="group border-t border-white/10 pt-12 first:border-t-0 first:pt-0">
                            <div className="flex flex-col items-start gap-6 md:gap-8 md:flex-row md:items-center">
                                {/* Left Image */}
                                ...
                                <div className="flex flex-col flex-grow">
                                    ...
                                    <h3 className="mb-4 md:mb-6 whitespace-pre-line text-2xl md:text-3xl font-bold uppercase leading-tight text-white font-[family-name:var(--font-oswald)]">
                                        {item.title}
                                    </h3>
                                </div>

                                {/* Button */}
                                <button className="w-full md:w-auto shrink-0 bg-white px-8 py-3 text-sm font-bold uppercase tracking-wider text-[#1a0f0a] transition-all hover:bg-[#eecb45]">
                                    Order Now
                                </button>
                            </div>
                        </div>
