            ...
            <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
                ...
                <div className="flex items-center gap-6">
                    <div className="hidden items-center gap-2 md:flex">
                        ...
                        <span className="text-lg font-bold text-[#1a1a1a]">555-123-4567</span>
                    </div>
                    <button className="rounded-sm bg-[#d25d1e] px-8 py-3 text-sm font-bold uppercase tracking-wider text-white transition-all hover:bg-[#b04a18] hover:shadow-lg active:scale-95">
                        Get in touch
                    </button>
                </div>
            </div>
